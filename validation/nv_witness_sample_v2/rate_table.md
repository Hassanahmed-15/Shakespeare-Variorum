...
| Plays | 21 |
| Notes sampled | 1050 |
| Scored (excl. cross-ref/gloss) | 932 |
| Located in witness (verifiable) | 360 (38.6%) |
| **Accuracy (verifiable notes, strict)** | **82.5%** |
| Accuracy (verifiable, + OCR tolerance) | 87.8% |
| Defective (verifiable only) | 12.2% |
| Unverifiable (witness locate failed) | 61.4% |
| Exempt (cross-ref / short gloss) | 118 |

Approx. 95% CI on strict accuracy among verifiable notes: ±3.9 percentage points.
...
| Othello | 50 | 5 | 7 | 100.0 | 100.0 | 0.0 | 84.1 |
