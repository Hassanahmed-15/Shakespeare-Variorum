...
| Metric | Count | Rate |
|--------|------:|-----:|
| Total play lines | 67,808 | — |
| Lines containing `[` | 2,409 | 3.5527% of play lines |
| Bracket SD triggers (`[…]` whole line) | 2,248 | 3.3152% of play lines |
| **Misclassified (false positives)** | **52** | **0.0767% of play lines** |
| Misclassified / bracket SD triggers | 52 / 2,248 | **2.3132%** |

### Interpretation

The misclassification rate is **0.0767%** of play lines (52 / 67,808).

### Paper-ready sentence

> We audited stage-direction styling across all 21 NV playtext volumes (67,808 play lines). The UI treats any line fully wrapped in square brackets as a stage direction. Heuristic review identified **52** false positives (**0.08%** of play lines; **2.31%** of bracket-wrapped lines), chiefly dialogue or note fragments accidentally bracketed during digitization. The failure mode is cosmetic—mis-set typography and TTS skipping—not note loss.
